...
# %%
# 코스닥 지수 데이터 불러오기(2020-08-01 ~ 2023-09-30)
...
# %%
# 삼프로 감성지수 데이터 불러오기(2020-09-09 ~ 2023-09-08)
...
# %%
# 삼프로 감성지수 데이터와 코스닥 지수 데이터 merge
...
# %%
pro3_data = data[['unique_id_y', 'y_y', 'y_y_ma5']][26:768].reset_index(drop=True)


# %%
kosdaq_data = data[['ds', 'unique_id_x', 'y_x', 'y_x_ma5']][41:].reset_index(drop=True) # 삼프로 일별 감성지수 15일 뒤 코스닥 데이터
...
# %%
# 단일 시계열
df1 = kosdaq[26:].reset_index(drop=True) # 전 기간
