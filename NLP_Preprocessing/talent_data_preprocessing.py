# -*- coding: utf-8 -*-
"""talent_data_preprocessing.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1s1y_sqyY3S2A-o02qLWW6A20HkttC0NS
"""
...
# youtube_df 불러오기
youtube_df = pd.read_csv('/content/drive/MyDrive/유튜브스크립트/달란트tv.csv', index_col=0)
...
# 문장 토큰화 결과 저장
data.to_csv('/content/drive/MyDrive/유튜브스크립트/talent_data_for_sent_analysis.csv', encoding='utf-8-sig')